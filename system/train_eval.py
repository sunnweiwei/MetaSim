...
def main():
    ...
    ## Required parameters
    parser.add_argument("--train_data_file", default='data/domain_0.1_total_clean_train.json', type=str,
    ...
    # model parameters
    parser.add_argument('--model_config', default='newest_model/data-10_context-15/final_tr0.29324677444964886/config.json', type=str, required=False,
                        help='选择模型参数')
    parser.add_argument("--model_path", default="newest_model/data-10_context-15/final_tr0.29324677444964886/", type=str,
                        help="The model checkpoint for weights initialization.")
    parser.add_argument("--tokenizer_dir", default="model/pretrained/", type=str,help="The model checkpoint for weights initialization.")
    ...
    args.output_dir += f'data-{args.domain}_context-{args.max_turn}_clean/'
