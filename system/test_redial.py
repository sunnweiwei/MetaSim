...
for idx in range(54):
    ...
    if idx < 4:
        ...
        config['task'] = 'redial-context-3'
    elif idx < 12:
        config['dataset'] = 'redial'
        config['system'] = 'data-100_context-1'
        config['task'] = 'redial-context-1'
    # multiwoz domain
    elif idx < 16:
        config['dataset'] = 'redial'
        config['system'] = 'data-10_context-15'
        config['task'] = 'redial-domain-3'
    elif idx < 20:
        config['dataset'] = 'redial'
        config['system'] = 'data-1_context-15'
        config['task'] = 'redial-domain-1'
    # multiwoz recommender
    elif idx < 24:
        config['dataset'] = 'redial'
        config['system'] = 'data-100_context-15'
        config['task'] = 'redial-recommend-3'
    elif idx < 28:
        config['dataset'] = 'redial'
        config['system'] = 'data-100_context-15'
        config['task'] = 'redial-recommend-1'
    # elif idx < 48:
